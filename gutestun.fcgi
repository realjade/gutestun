...
# 命令行参数
parser = argparse.ArgumentParser(description=u'Run an gutestun FastCGI server')
...
if __name__ == '__main__':
    ...
    daemon = GutestunDaemon(gen_pidfile(args.port))
